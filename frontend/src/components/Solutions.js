    ...
    <div className="solutions-section">
      ...
      <div className="solution-list">
        <div className="solution-item">
          ...
          <Link to="/solutions/text-to-speech">
        ...
        <div className="solution-item">
          ...
          <Link to="/solutions/speech-to-text">
            Click Here for More Details
          </Link>
        </div>
        <div className="solution-item">
          ...
          <Link to="/solutions/generate-content">
            Click Here for More Details
          </Link>
        </div>
        <div className="solution-item">
        ...
        <div className="solution-item">
          ...
          <Link to="/solutions/generate-image">
            Click Here for More Details
          </Link>
        </div>
        <div className="solution-item">
        ...
        <div className="solution-item">
          ...
          <Link to="/solutions/shorts-language-converter">
            Click Here for More Details
          </Link>
        </div>
        <div className="solution-item">
          ...
          <p>Generate video.</p>
          <Link to="/solutions/generate-video">
            Click Here for More Details
          </Link>
        </div>
        <div className="solution-item">
